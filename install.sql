...
@@workspace/credentials/groq_credential.sql
@@workspace/remote_servers/api_groq_com_openai_v1.sql
@@application/shared_components/data_profiles/groq_api.sql
@@application/shared_components/web_sources/groq_api.sql
